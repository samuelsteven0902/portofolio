...
const Home = () => {
  ...
  return (
    <div  className='section w-full min-h-screen  bg-[#041C32]' >
      ...
      <div className='w-full mx-auto px-8 flex flex-col justify-center h-1/2 lg:h-full 2xl:w-1/2 lg:w-1/3 pt-32 xl:pt-0 items-center' data-aos='fade-left' data-aos-duration='1500' data-aos-delay='600'>
